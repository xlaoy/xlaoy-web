...
public class LocalDateTimeUtils {
    ...
    public static final String NORMAL_DATETIME = "yyyy-MM-dd HH:mm:ss";
    ...
    public static final String NDATE = "yyyyMMdd";

    public static final DateTimeFormatter DTF = DateTimeFormatter.ofPattern(NORMAL_DATETIME);
    public static final DateTimeFormatter DF = DateTimeFormatter.ofPattern(NORMAL_DATE);
    public static final DateTimeFormatter TF = DateTimeFormatter.ofPattern(NORMAL_TIME);
    ...
    //获取指定时间的常用格式
    public static String formatTimeNormal(LocalDateTime time) {
        return time.format(DTF);
    }

    //获取指定时间的常用格式
    public static String formatDateNormal(LocalDateTime time) {
        return time.format(DF);
    }

    //获取指定格式的指定时间
    public static LocalDateTime formatTimeNormal(String time) {
